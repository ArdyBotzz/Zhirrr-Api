...
var creatorList = ['@Ardy','@AdyyGanzz','@ArdyGanteng','@ArdyBotz', '@ArdyBotzz','@ArdyStore','@Ardy'];
...
router.get('/find', async (req, res, next) => {
    ...
    if (apikey != 'ArdyStore') return res.json(loghandler.invalidKey)
...
router.get('/tiktod', async (req, res, next) => {
	...
	if(!apikeyInput) return res.json(loghandler.notparam)
	if(apikeyInput != 'ArdyStore') return res.json(loghandler.invalidKey)
